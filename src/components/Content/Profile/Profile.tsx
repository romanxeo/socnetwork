        ...
        <div className={s.profile}>
            ...
            {(props.profile.lookingForAJob)
                ? <div className={s.aboutMe}>
                    ...
                    <span className={s.descriptionSpan}> {props.profile.lookingForAJobDescription}</span>
                </div>
                : <></>
            }
            ...
            <div className={s.linkContainer}>
                ...
                {(props.profile.contacts.website != null)
                    ? <a href={props.profile.contacts.website}><img src={imgWeb} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.vk != null)
                    ? <a href={props.profile.contacts.vk}><img src={imgVK} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.twitter != null)
                    ? <a href={props.profile.contacts.twitter}><img src={imgTW} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.instagram != null)
                    ? <a href={props.profile.contacts.instagram}><img src={imgIG} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.youtube != null)
                    ? <a href={props.profile.contacts.youtube}><img src={imgYB} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.github != null)
                    ? <a href={props.profile.contacts.github}><img src={imgGH} className={s.linkImg}/></a>
                    : <></>}

                {(props.profile.contacts.mainLink != null)
                    ? <a href={props.profile.contacts.mainLink}><img src={imgGM} className={s.linkImg}/></a>
                    : <></>}
